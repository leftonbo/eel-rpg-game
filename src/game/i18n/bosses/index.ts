...
import { xenoTendrilBeastTranslations } from './xeno-tendril-beast';
...
export const bossTranslations = {
    ja: {
        ...
        'xeno-tendril-beast': xenoTendrilBeastTranslations.ja
    },
    en: {
        ...
        'dual-jester': dualJesterTranslations.en,
        'fluffy-dragon': fluffyDragonTranslations.en,
        'mech-spider': mechSpiderTranslations.en,
        'mikan-dragon': mikanDragonTranslations.en,
        'scorpion-carrier': scorpionCarrierTranslations.en,
        'sea-kraken': seaKrakenTranslations.en,
        ...
        'xeno-tendril-beast': xenoTendrilBeastTranslations.en
    }
};
